var conferenceRooms = {};
conferenceRooms.whereisGet = function(req, res) {
    var location = {};
    const rooms = ["Intuition Does Not Come To An Unprepared Mind", "We Love Our Employees", 
    "Blue Sky", "Communication Is Leadership", "Air Of Excitement", "Main And Main", 
    "Data Central", "Contain Yourself","All Eyes On Elfa", "Fun And Functional", 
    "Air Of Excitement", "Fun And Functional", "Gumby"];

    if(req.query.q.toLowerCase()==="list conference rooms"){
